...
- Rings in the Reliquary recharge uses on the game day timer. At the Sanctum, the RECHARGE action also restores uses on resting Reliquary rings (after carried rings, in priority order).
